...
weeks = week = wk = w = Unit(Duration, "wk", 604_800)
years = year = yr = y = Unit(Duration, "yr", 31_536_000)
decades = decade = dec = Unit(Duration, "dec", 315_360_000)
centuries = century = cent = c = Unit(Duration, "cent", 3_153_600_000)
millenia = millenium = mil = ka = ky = Unit(Duration, "mil", 31_536_000_000)
