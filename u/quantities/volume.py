...
cubic_meters = cubic_meter = m3 = Unit(meter**3, "m³", systems={"metric"})
...
# US Gallon
gallons = gallon = gal = Unit(
    Volume, "gal", decimal.Decimal("0.003785411784"), systems={"imperial"}
)
...
fluid_ounces = fluid_ounce = floz = Unit(
    Volume, "fl oz", decimal.Decimal("2.95735295625e-5"), systems={"imperial"}
)
tablespoons = tablespoon = tbsp = Unit(
    Volume, "tbsp", decimal.Decimal("1.478676478125e-5"), systems={"imperial"}
)
teaspoons = teaspoon = tsp = Unit(
    Volume, "tsp", decimal.Decimal("4.92892159375e-6"), systems={"imperial"}
)
