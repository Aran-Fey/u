...
electronvolts = electronvolt = eV = Unit(Energy, "eV", decimal.Decimal("1.602176634e-19") * joule.multiplier, systems={"technical"})
ergs = erg = Unit(Energy, "erg", decimal.Decimal("1e-7") * joule.multiplier, systems={"metric"})
btus = btu = BTU = Unit(Energy, "BTU", decimal.Decimal("1055.05585262") * joule.multiplier, systems={"imperial"})
